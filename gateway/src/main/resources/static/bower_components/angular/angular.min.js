...
(function (S, W, u) {
 ...
 function y(b) {
  return function () {
   var a = arguments[0], c;
   c = "[" + (b ? b + ":" : "") + a + "] http://errors.angularjs.org/1.3.19/" + (b ? b + "/" : "") + a;
 ...
 function Sa(b) {
  ...
  return b.nodeType === ma && a ? !0 : K(b) || x(b) || 0 === a || "number" === typeof a && 0 < a && a - 1 in b
 }

 function q(b, a, c) {
  var d, e;
  if (b)if (B(b))for (d in b)"prototype" == d || "length" == d || "name" == d || b.hasOwnProperty && !b.hasOwnProperty(d) || a.call(c, b[d], d, b); else if (x(b) || Sa(b)) {
 ...
 function ta(b) {
  return P(b.nodeName || b[0] && b[0].nodeName)
 }
 ...
 function Ba(b, a, c, d) {
  ...
  if (a) {
   ...
   if (x(b))for (var f = a.length = 0; f < b.length; f++)e = Ba(b[f], null, c, d), J(b[f]) && (c.push(b[f]),
       d.push(e)), a.push(e); else {
    var g = a.$$hashKey;
    x(a) ? a.length = 0 : q(a, function (b, c) {
     delete a[c]
    });
    for (f in b)b.hasOwnProperty(f) && (e = Ba(b[f], null, c, d), J(b[f]) && (c.push(b[f]), d.push(e)), a[f] = e);
    pc(a, g)
   }
  } else if (a = b)x(b) ? a = Ba(b, [], c, d) : ea(b) ? a = new Date(b.getTime()) : Ua(b) ? (a = new RegExp(b.source, b.toString().match(/[^\/]*$/)[0]), a.lastIndex = b.lastIndex) : J(b) && (e = Object.create(Object.getPrototypeOf(b)), a = Ba(b, e, c, d));
  return a
 }
 ...
 function fa(b, a) {
  ...
  if (c == typeof a && "object" == c)if (x(b)) {
   ...
   if (Va(b) || Va(a) || Ta(b) || Ta(a) || x(a) || ea(a) || Ua(a))return !1;
   c = {};
   for (d in b)if ("$" !==
       d.charAt(0) && !B(b[d])) {
   ...
   for (d in a)if (!c.hasOwnProperty(d) && "$" !== d.charAt(0) && a[d] !== u && !B(a[d]))return !1;
   return !0
  }
  return !1
 }
 ...
 function Ld(b, a) {
  var c = a;
  "string" === typeof b &&
  "$" === b.charAt(0) && "$" === b.charAt(1) ? c = u : Ta(a) ? c = "$WINDOW" : a && W === a ? c = "$DOCUMENT" : Va(a) && (c = "$SCOPE");
  return c
 }
 ...
 function ua(b) {
  ...
  var c = G("<div>").append(b).html();
  try {
   return b[0].nodeType === ab ? P(c) : c.match(/^(<[^>]+>)/)[1].replace(/^<([\w\-]+)/, function (a, b) {
    return "<" + P(b)
   })
  } catch (d) {
   return P(c)
 ...
 function uc(b) {
  ...
  q((b || "").split("&"), function (b) {
   b && (c = b.replace(/\+/g, "%20").split("="), d = tc(c[0]), D(d) && (b = D(c[1]) ? tc(c[1]) : !0, vc.call(a, d) ? x(a[d]) ? a[d].push(b) : a[d] = [a[d], b] : a[d] = b))
  });
  return a
 }
 ...
 function Md(b, a) {
  var c, d, e = ub.length;
  b = G(b);
  for (d = 0; d < e; ++d)if (c = ub[d] + a, K(c = b.attr(c)))return c;
  return null
 }
 ...
 function Nd(b, a) {
  ...
  c && (e.strictDi = null !== Md(c, "strict-di"),
      a(c, d ? [d] : [], e))
 }
 ...
 function wc(b, a, c) {
  ...
  B(ba.resumeDeferredBootstrap) && ba.resumeDeferredBootstrap()
 }
 ...
 function Rd() {
  var b;
  yc || ((pa = S.jQuery) && pa.fn.on ? (G = pa, z(pa.fn, {
   scope: Ka.scope,
 ...
 function La(b, a, c) {
  ...
  Sb(B(b), a, "not a function, got " + (b && "object" === typeof b ? b.constructor.name || "Object" : typeof b));
  return b
 }
  ...
  return a(b, "module", function () {
   ...
   return function (f, g, h) {
    ...
    return a(b, f, function () {
     ...
     var b = [], d = [], e = [], n = a("$injector", "invoke", "push", d), s = {
      _invokeQueue: b,
      _configBlocks: d,
      _runBlocks: e,
      requires: g,
 ...
 function Td(b) {
  ...
  try {
   ...
   db("ngLocale", []).provider("$locale", Vd)
  }
  db("ng", ["ngLocale"], ["$provide", function (a) {
   ...
   a.provider("$compile", Ac).directive({
    ...
    ngValue: Ce,
    ngModelOptions: De
   }).directive({ngInclude: Ee}).directive(xb).directive(Gc);
   a.provider({
    $anchorScroll: Fe,
    $animate: Ge,
    $browser: He,
 ...
 function R(b) {
  ...
  if (a) {
   a = W;
   var c;
   b = (c = lf.exec(b)) ? [a.createElement(c[1])] : (c = Jc(b, a)) ? c.childNodes : []
  }
  Kc(this, b)
 }
 ...
 function yb(b, a) {
  a || zb(b);
  if (b.querySelectorAll)for (var c = b.querySelectorAll("*"), d = 0, e = c.length; d < e; d++)zb(c[d])
 }

 function Lc(b, a, c, d) {
  if (D(d))throw Ub("offargs");
  var e = (d = Ab(b)) && d.events, f = d && d.handle;
  if (f)if (a)q(a.split(" "),
      function (a) {
       if (D(c)) {
        var d = e[a];
 ...
 function zb(b, a) {
  var c = b.ng339, d = c && Bb[c];
  d && (a ? delete d.data[a] : (d.handle && (d.events.$destroy && d.handle({}, "$destroy"), Lc(b)), delete Bb[c], b.ng339 = u))
 }

 function Ab(b, a) {
  var c = b.ng339, c = c && Bb[c];
  a && !c && (b.ng339 = c = ++mf, c = Bb[c] = {events: {}, data: {}, handle: u});
  return c
 }
 ...
 function Fb(b, a, c) {
  ...
  for (a = x(a) ? a : [a]; b;) {
   for (var d = 0, e = a.length; d < e; d++)if ((c = G.data(b, a[d])) !== u)return c;
   b = b.parentNode ||
 ...
 function Nc(b) {
  for (yb(b, !0); b.firstChild;)b.removeChild(b.firstChild)
 }
 ...
 function nf(b, a) {
  a = a || S;
  if ("complete" === a.document.readyState)a.setTimeout(b); else G(a).on("load", b)
 }
 ...
 function of(b, a) {
  var c = b.nodeName;
  return ("INPUT" === c || "TEXTAREA" === c) && Rc[a]
 }
 ...
 function Na(b, a) {
  ...
  c = typeof b;
  return c = "function" == c || "object" == c && null !== b ? b.$$hashKey = c + ":" + (a || Jd)() : c + ":" + b
 }
 ...
 function bb(b, a) {
  function c(a) {
   return function (b, c) {
    if (J(b))q(b, oc(a)); else return a(b, c)
   }
  }

  function d(a, b) {
   Ma(a, "service");
   if (B(b) || x(b))b = n.instantiate(b);
  ...
  function g(a) {
   ...
   q(a, function (a) {
    ...
    if (!m.get(a)) {
     m.put(a, !0);
     try {
      K(a) ? (c = db(a), b = b.concat(g(c.requires)).concat(c._runBlocks), d(c._invokeQueue), d(c._configBlocks)) : B(a) ? b.push(n.invoke(a)) : x(a) ? b.push(n.invoke(a)) : La(a, "module")
     } catch (e) {
  ...
  function h(b, c) {
   ...
   function e(b, c, f, g) {
    ...
    var l = [], k = bb.$$annotate(b, a, g), h, n, m;
    n = 0;
    for (h = k.length; n < h; n++) {
     m = k[n];
     if ("string" !== typeof m)throw Da("itkn", m);
     l.push(f && f.hasOwnProperty(m) ? f[m] : d(m, g))
    }
    x(b) && (b = b[h]);
    return b.apply(c, l)
   }
   ...
   return {
    invoke: e, instantiate: function (a, b, c) {
     var d = Object.create((x(a) ? a[a.length - 1] : a).prototype || null);
     a = e(a, d, b, c);
     return J(a) || B(a) ? a : d
  ...
  }), s = {}, t = s.$injector = h(s, function (a, b) {
  ...
  this.$get = ["$window", "$location", "$rootScope", function (a, c, d) {
   ...
   function f(b) {
    if (b) {
     ...
     var c;
     c = g.yOffset;
     B(c) ? c = c() : qc(c) ? (c = c[0], c = "fixed" !==
     a.getComputedStyle(c).position ? 0 : c.getBoundingClientRect().bottom) : U(c) || (c = 0);
 ...
 function rf(b, a, c, d) {
  ...
  function l() {
   if (I !== m.url() || C !== L)I = m.url(), C = L, q($, function (a) {
    a(m.url(), L)
   })
  }
  ...
  var m = this, r = a[0], n = b.location, s = b.history, t = b.setTimeout, w = b.clearTimeout, v = {};
  m.isMock = !1;
  var p = 0, H = [];
  ...
  var L, C, I = n.href, N = a.find("base"), Y = null;
  h();
  C = L;
  m.url = function (a, c, e) {
   ...
   if (a) {
    var f =
        C === e;
    if (I === a && (!d.history || f))return m;
    var g = I && Ea(I) === Ea(a);
    I = a;
    C = e;
    if (!d.history || g && f) {
     if (!g || Y)Y = a;
     c ? n.replace(a) : g ? (c = n, e = a.indexOf("#"), a = -1 === e ? "" : a.substr(e), c.hash = a) : n.href = a
    } else s[c ? "replaceState" : "pushState"](e, "", a), h(), C = L;
    return m
   }
  ...
  m.onUrlChange = function (a) {
   if (!V) {
    if (d.history)G(b).on("popstate", g);
    G(b).on("hashchange", g);
    V = !0
   }
   $.push(a);
  ...
  var Fa = {}, D = "", hb = m.baseHref();
  m.cookies = function (a, b) {
   var d, e, f, g;
   if (a)b === u ? r.cookie = encodeURIComponent(a) + "=;path=" + hb + ";expires=Thu, 01 Jan 1970 00:00:00 GMT" : K(b) && (d = (r.cookie = encodeURIComponent(a) + "=" + encodeURIComponent(b) + ";path=" + hb).length + 1, 4096 < d && c.warn("Cookie '" + a + "' possibly not set or overflowed because it was too large (" + d + " > 4096 bytes)!")); else {
    if (r.cookie !== D)for (D = r.cookie, d = D.split("; "), Fa = {}, f = 0; f < d.length; f++)e =
  ...
  m.defer.cancel = function (a) {
   return v[a] ? (delete v[a], w(a), e(F), !0) : !1
  }
 }
 ...
 function Ie() {
  this.$get = function () {
   function b(b, d) {
    ...
    var g = 0, h = z({}, d, {id: b}), l = {}, k = d && d.capacity || Number.MAX_VALUE, m = {}, r = null, n = null;
    return a[b] = {
     put: function (a, b) {
      ...
      if (!A(b))return a in l || g++, l[a] = b, g > k && this.remove(n.key), b
     }, get: function (a) {
      if (k < Number.MAX_VALUE) {
       var b = m[a];
       if (!b)return;
 ...
 function Ac(b, a) {
  ...
  function d(a) {
   var b = a.charAt(0);
   if (!b || b !== P(b))throw da("baddir", a);
   return a
  }

  var e = {}, f = /^\s*directive\:\s*([\w\-]+)\s+(.*)$/, g = /(([\w\-]+)(?:\:([^;]+))?;?)/, h = Kd("ngSrc,ngSrcset,src,srcset"), l = /^(?:(\^\^?)?(\?)?(\^\^?)?)?/, k = /^(on[a-z]+|formaction)$/;
  this.directive = function n(a, f) {
   Ma(a, "directive");
   K(a) ? (d(a), Sb(f, "directiveFactory"), e.hasOwnProperty(a) || (e[a] = [], b.factory(a + "Directive", ["$injector", "$exceptionHandler", function (b, d) {
    var f = [];
    q(e[a], function (e, g) {
     try {
      var h = b.invoke(e);
  ...
  this.debugInfoEnabled = function (a) {
   return D(a) ? (m = a, this) : m
  };
  this.$get = ["$injector", "$interpolate", "$exceptionHandler", "$templateRequest", "$parse", "$controller", "$rootScope", "$document", "$sce", "$animate", "$$sanitizeUri", function (a, b, c, d, v, p, H, E, Q, L, C) {
   function I(a, b) {
    try {
     a.addClass(b)
    } catch (c) {
   ...
   function N(a, b, c, d, e) {
    ...
    q(a, function (b, c) {
     ...
     (a[c] = G(b).wrap("<span></span>").parent()[0])
    });
    var f = Y(a, b, a, c, d, e);
    N.$$addScopeClass(a);
    var g = null;
    return function (b, c, d) {
     ...
     d = "html" !== g ? G(S(g, G("<div>").append(a).html())) : c ? Ka.clone.call(a) : a;
   ...
   function Y(a, b, c, d, e, f) {
    function g(a, c, d, e) {
     var f, l, k, n, m, t, s;
     if (p)for (s = Array(c.length), n = 0; n < h.length; n += 3)f = h[n], s[f] = c[f]; else s = c;
     n = 0;
     for (m = h.length; n < m;)l = s[h[n++]], c = h[n++], f = h[n++], c ? (c.scope ? (k = a.$new(), N.$$addScopeInfo(G(l), k)) : k = a, t = c.transcludeOnThisElement ? $(a, c.transclude, e, c.elementTranscludeOnThisElement) : !c.templateOnThisElement && e ? e : !e && b ? $(a, b) : null, c(f, k, l, d, t)) : f && f(a, l.childNodes, u, e)
    }

    for (var h = [], l, k, n, m, p, t = 0; t < a.length; t++) {
     l = new $b;
     k =
         V(a[t], [], l, 0 === t ? d : u, e);
     (f = k.length ? D(k, a[t], l, b, c, null, [], [], f) : null) && f.scope && N.$$addScopeClass(l.$$element);
     l = f && f.terminal || !(n = a[t].childNodes) || !n.length ? null : Y(n, f ? (f.transcludeOnThisElement || !f.templateOnThisElement) && f.transclude : b);
     if (f || l)h.push(t, f, l), m = !0, p = p || f;
     f = null
    }
    return m ? g : null
   }
   ...
   function V(a, b, c, d, e) {
    ...
    switch (a.nodeType) {
     case ma:
      A(b, wa(ta(a)), "E", d, e);
      for (var k, n, m, p = a.attributes, t = 0, s = p && p.length; t < s; t++) {
       var L = !1, Q = !1;
       k = p[t];
       l = k.name;
       n = T(k.value);
       k = wa(l);
       if (m = ac.test(k))l = l.replace(Vc, "").substr(8).replace(/_(.)/g, function (a, b) {
        return b.toUpperCase()
       });
       var w = k.replace(/(Start|End)$/, "");
       y(w) && k === w + "Start" && (L = l, Q = l.substr(0, l.length - 5) + "end", l = l.substr(0, l.length - 6));
       k = wa(l.toLowerCase());
       h[k] = l;
       if (m || !c.hasOwnProperty(k))c[k] = n, Pc(a, k) && (c[k] = !0);
       R(a, b, n, k, m);
       A(b, k, "A", d, e, L, Q)
      }
      a =
          a.className;
      J(a) && (a = a.animVal);
      if (K(a) && "" !== a)for (; l = g.exec(a);)k = wa(l[2]), A(b, k, "C", d, e) && (c[k] = T(l[3])), a = a.substr(l.index + l[0].length);
      break;
     case ab:
      ia(b, a.nodeValue);
      break;
     case 8:
      try {
       if (l = f.exec(a.nodeValue))k = wa(l[1]), A(b, k, "M", d, e) && (c[k] = T(l[2]))
      } catch (v) {
      }
    }
    b.sort(xa);
   ...
   function D(a, d, e, f, g, h, k, n, m) {
    function L(a, b, c, d) {
     if (a) {
      c && (a = Fa(a, c, d));
      a.require = M.require;
      a.directiveName = ia;
      if (E === M || M.$$isolateScope)a = X(a, {isolateScope: !0});
      k.push(a)
     }
     if (b) {
      c && (b = Fa(b, c, d));
      b.require = M.require;
      b.directiveName = ia;
      if (E === M || M.$$isolateScope)b = X(b, {isolateScope: !0});
      n.push(b)
     }
    }
    ...
    function Q(a, b, c, d) {
     ...
     x(b) && (e = [], q(b, function (b) {
      e.push(Q(a, b, c, d))
     }));
     return e
    }

    function w(a, c, f, g, h) {
     function l(a, b, c) {
      var d;
      Va(a) || (c = b, b = a, a = u);
      F && (d = H);
     ...
     var m, t, L, C, H, ib, O, V;
     d === f ? (V = e, O = e.$$element) : (O = G(f), V = new $b(O, e));
     E && (C = c.$new(!0));
     h &&
     (ib = l, ib.$$boundTransclude = h);
     I && ($ = {}, H = {}, q(I, function (a) {
      var b = {$scope: a === E || a.$$isolateScope ? C : c, $element: O, $attrs: V, $transclude: ib};
      L = a.controller;
      "@" == L && (L = V[a.name]);
      b = p(L, b, !0, a.controllerAs);
      H[a.name] = b;
      F || O.data("$" + a.name + "Controller", b.instance);
      $[a.name] = b
     }));
     if (E) {
      N.$$addScopeInfo(O, C, !0, !(Y && (Y === E || Y === E.$$originalDirective)));
      N.$$addScopeClass(O, !0);
      g = $ && $[E.name];
      var va = C;
      g && g.identifier && !0 === E.bindToController && (va = g.instance);
      q(C.$$isolateBindings = E.$$isolateBindings, function (a,
                                                             d) {
       var e = a.attrName, f = a.optional, g, h, l, k;
       switch (a.mode) {
        case "@":
         V.$observe(e, function (a) {
          va[d] = a
         });
         V.$$observers[e].$$scope = c;
         V[e] && (va[d] = b(V[e])(c));
         break;
        case "=":
         if (f && !V[e])break;
         ...
         l = h.assign || function () {
              g = va[d] = h(c);
              throw da("nonassign", V[e], E.name);
             };
         g = va[d] = h(c);
         f = function (a) {
          k(a, va[d]) || (k(a, g) ? l(c, a = va[d]) : va[d] = a);
          return g = a
         };
         f.$stateful = !0;
         f = a.collection ? c.$watchCollection(V[e], f) : c.$watch(v(V[e], f), null, h.literal);
         C.$on("$destroy",
             f);
         break;
        case "&":
         h = v(V[e]), va[d] = function (a) {
          return h(c, a)
         }
       }
      })
     ...
     g = 0;
     for (m = k.length; g < m; g++)t = k[g], Wc(t, t.isolateScope ? C : c, O, V, t.require && Q(t.directiveName, t.require, O, H), ib);
     var Zb = c;
     E && (E.template || null === E.templateUrl) && (Zb = C);
     a && a(Zb, f.childNodes, u, h);
     for (g = n.length - 1; 0 <= g; g--)t = n[g], Wc(t, t.isolateScope ? C : c, O, V, t.require && Q(t.directiveName, t.require, O, H), ib)
    }

    m = m || {};
    for (var C = -Number.MAX_VALUE, H, I = m.controllerDirectives, $, E = m.newIsolateScopeDirective, Y = m.templateDirective,
             Ga = m.nonTlbTranscludeDirective, A = !1, Yb = !1, F = m.hasElementTranscludeDirective, z = e.$$element = G(d), M, ia, y, gb = f, xa, qa = 0, P = a.length; qa < P; qa++) {
     M = a[qa];
     var R = M.$$start, jb = M.$$end;
     R && (z = O(d, R, jb));
     y = u;
     if (C > M.priority)break;
     if (y = M.scope)M.templateUrl || (J(y) ? (Oa("new/isolated scope", E || H, M, z), E = M) : Oa("new/isolated scope", E, M, z)), H = H || M;
     ia = M.name;
     !M.templateUrl && M.controller && (y = M.controller, I = I || {}, Oa("'" + ia + "' controller", I[ia], M, z), I[ia] = M);
     if (y = M.transclude)A = !0, M.$$tlb || (Oa("transclusion", Ga, M, z), Ga = M),
         "element" == y ? (F = !0, C = M.priority, y = z, z = e.$$element = G(W.createComment(" " + ia + ": " + e[ia] + " ")), d = z[0], U(g, Za.call(y, 0), d), gb = N(y, f, C, h && h.name, {nonTlbTranscludeDirective: Ga})) : (y = G(Vb(d)).contents(), z.empty(), gb = N(y, f));
     if (M.template)if (Yb = !0, Oa("template", Y, M, z), Y = M, y = B(M.template) ? M.template(z, e) : M.template, y = Xc(y), M.replace) {
      h = M;
      y = Tb.test(y) ? Yc(S(M.templateNamespace, T(y))) : [];
      d = y[0];
      if (1 != y.length || d.nodeType !== ma)throw da("tplrt", ia, "");
      U(g, z, d);
      P = {$attr: {}};
      y = V(d, [], P);
      var sf = a.splice(qa + 1, a.length -
          (qa + 1));
      E && hb(y);
      a = a.concat(y).concat(sf);
      Uc(e, P);
      P = a.length
     } else z.html(y);
     if (M.templateUrl)Yb = !0, Oa("template", Y, M, z), Y = M, M.replace && (h = M), w = Xb(a.splice(qa, a.length - qa), z, e, g, A && gb, k, n, {
      controllerDirectives: I,
      newIsolateScopeDirective: E,
      templateDirective: Y,
      nonTlbTranscludeDirective: Ga
     }), P = a.length; else if (M.compile)try {
      xa = M.compile(z, e, gb), B(xa) ? L(null, xa, R, jb) : xa && L(xa.pre, xa.post, R, jb)
     } catch (ac) {
      c(ac, ua(z))
     }
     M.terminal && (w.terminal = !0, C = Math.max(C, M.priority))
    }
    w.scope = H && !0 === H.scope;
    w.transcludeOnThisElement =
        A;
    w.elementTranscludeOnThisElement = F;
    w.templateOnThisElement = Yb;
    w.transclude = gb;
    m.hasElementTranscludeDirective = F;
    return w
   }
   ...
   function A(b, d, f, g, h, l, k) {
    if (d === h)return null;
    h = null;
    if (e.hasOwnProperty(d)) {
     var m;
     d = a.get(d + "Directive");
     for (var p = 0, L = d.length; p < L; p++)try {
      m = d[p], (g === u || g > m.priority) && -1 != m.restrict.indexOf(f) && (l && (m = Pb(m, {
       $$start: l,
       $$end: k
      })), b.push(m), h = m)
     } catch (s) {
   ...
   function Xb(a, b, c, e, f, g,
               h, l) {
    var k = [], n, m, p = b[0], t = a.shift(), L = Pb(t, {
     templateUrl: null,
     transclude: null,
     replace: null,
     $$originalDirective: t
    }), s = B(t.templateUrl) ? t.templateUrl(b, c) : t.templateUrl, Q = t.templateNamespace;
    b.empty();
    d(s).then(function (d) {
     var w, C;
     d = Xc(d);
     if (t.replace) {
      d = Tb.test(d) ? Yc(S(Q, T(d))) : [];
      w = d[0];
      if (1 != d.length || w.nodeType !== ma)throw da("tplrt", t.name, s);
      d = {$attr: {}};
      U(e, b, w);
      var v = V(w, [], d);
      J(t.scope) && hb(v);
     ...
     a.unshift(L);
     n = D(a, w, c, f, b, t, g, h, l);
     q(e, function (a, c) {
      a ==
      w && (e[c] = b[0])
     });
     for (m = Y(b[0].childNodes, f); k.length;) {
      d = k.shift();
      C = k.shift();
      var H = k.shift(), N = k.shift(), v = b[0];
      if (!d.$$destroyed) {
       if (C !== p) {
        var E = C.className;
        l.hasElementTranscludeDirective && t.replace || (v = Vb(w));
        U(H, G(C), v);
        I(G(v), E)
       }
       C = n.transcludeOnThisElement ? $(d, n.transclude, N) : N;
       n(m, d, v, e, C)
      }
     }
     k = null
    ...
    return function (a, b, c, d, e) {
     a = e;
     b.$$destroyed || (k ? k.push(b, c, d, a) : (n.transcludeOnThisElement && (a = $(b, n.transclude, e)), n(m, b, c, d, a)))
    }
   }
   ...
   function xa(a, b) {
    ...
    return 0 !== c ?
        c : a.name !== b.name ? a.name < b.name ? -1 : 1 : a.index - b.index
   }

   function Oa(a, b, c, d) {
    if (b)throw da("multidir", b.name, c.name, a, ua(d));
   }
   ...
   function R(a, c, d, e, f) {
    ...
    var l = b(d, !0, g, f);
    if (l) {
     if ("multiple" === e && "select" === ta(a))throw da("selmulti", ua(a));
     c.push({
   ...
   function U(a, b, c) {
    ...
    a.appendChild(d);
    G(c).data(G(d).data());
    pa ? (Rb = !0, pa.cleanData([d])) : delete G.cache[d[G.expando]];
    d = 1;
    for (e = b.length; d < e; d++)f = b[d], G(f).remove(), a.appendChild(f), delete b[d];
    b[0] = c;
    b.length = 1
   }
   ...
   $b.prototype = {
    $normalize: wa, $addClass: function (a) {
     a &&
     0 < a.length && L.addClass(this.$$element, a)
    }, $removeClass: function (a) {
     a && 0 < a.length && L.removeClass(this.$$element, a)
    }, $updateClass: function (a, b) {
     var c = Zc(a, b);
     c && c.length && L.addClass(this.$$element, c);
     (c = Zc(b, a)) && c.length && L.removeClass(this.$$element, c)
    }, $set: function (a, b, d, e) {
     var f = this.$$element[0], g = Pc(f, a), h = of(f, a), f = a;
     g ? (this.$$element.prop(a, b), e = g) : h && (this[h] = b, f = h);
     this[a] = b;
     e ? this.$attr[a] = e : (e = this.$attr[a]) || (this.$attr[a] = e = xc(a, "-"));
     g = ta(this.$$element);
     if ("a" === g && "href" === a || "img" ===
         g && "src" === a)this[a] = b = C(b, "src" === a); else if ("img" === g && "srcset" === a) {
      for (var g = "", h = T(b), l = /(\s+\d+x\s*,|\s+\d+w\s*,|\s+,|,\s+)/, l = /\s/.test(h) ? l : /(,)/, h = h.split(l), l = Math.floor(h.length / 2), k = 0; k < l; k++)var n = 2 * k, g = g + C(T(h[n]), !0), g = g + (" " + T(h[n + 1]));
      h = T(h[2 * k]).split(/\s/);
      g += C(T(h[0]), !0);
      2 === h.length && (g += " " + T(h[1]));
      this[a] = b = g
   ...
   var Ga = b.startSymbol(), qa = b.endSymbol(), Xc = "{{" == Ga || "}}" == qa ? na : function (a) {
 ...
 function Je() {
  ...
  this.$get = ["$injector", "$window", function (d, e) {
   function f(a, b, c, d) {
    if (!a || !J(a.$scope))throw y("$controller")("noscp", d, b);
    a.$scope[b] = c
   }
   ...
   return function (g, h, l, k) {
    ...
    if (K(g)) {
     k = g.match(c);
     if (!k)throw uf("ctrlfmt", g);
     r = k[1];
     n = n || k[3];
     g = b.hasOwnProperty(r) ? b[r] : zc(h.$scope, r, !0) || (a ? zc(e, r, !0) : u);
     La(g, r, !0)
    }
    if (l)return l = (x(g) ? g[g.length -
    1] : g).prototype, m = Object.create(l || null), n && f(h, n, m, r || g.name), z(function () {
     d.invoke(g, m, h, r);
     return m
 ...
 function bc(b, a) {
  if (K(b)) {
   ...
   if (c) {
    ...
    (d = d && 0 === d.indexOf($c)) || (d = (d = c.match(wf)) && xf[d[0]].test(c));
    d && (b = sc(c))
   }
  }
  return b
 ...
 function bd(b) {
  ...
  return function (c) {
   a || (a = ad(b));
   return c ? (c = a[P(c)], void 0 === c && (c = null), c) : a
  }
 }
  ...
  this.$get = ["$httpBackend", "$browser", "$cacheFactory", "$rootScope", "$q", "$injector", function (d, e, f, g, h, l) {
   function k(a) {
    ...
    function d(a) {
     var b, c = {};
     q(a, function (a, d) {
      B(a) ? (b = a(), null != b && (c[d] = b)) : c[d] = a
     });
     return c
    }

    if (!ba.isObject(a))throw y("$http")("badreq", a);
    var e = z({method: "get", transformRequest: b.transformRequest, transformResponse: b.transformResponse}, a);
    e.headers = function (a) {
     var c = b.headers, e = z({}, a.headers), f, g, c = z({}, c.common, c[P(a.method)]);
     a:for (f in c) {
      a = P(f);
      for (g in e)if (P(g) === a)continue a;
      e[f] = c[f]
     }
     return d(e)
    }(a);
    e.method = wb(e.method);
    var f = [function (a) {
     var d = a.headers, e = cd(a.data, bd(d), u, a.transformRequest);
     A(e) && q(d, function (a, b) {
   ...
   function m(c, f) {
    function l(b, c, d, e) {
     ...
     C && (200 <= b && 300 > b ? C.put(q, [b, c, ad(d), e]) : C.remove(q));
     a ? g.$applyAsync(f) : (f(), g.$$phase || g.$apply())
    }

    function m(a, b, d, e) {
     b = -1 <= b ? b : 0;
     (200 <= b && 300 > b ? Q.resolve : Q.reject)({data: a, status: b, headers: bd(d), config: c, statusText: e})
    }
    ...
    var Q = h.defer(), L = Q.promise, C, I, N = c.headers, q = r(c.url, c.params);
    k.pendingRequests.push(c);
    L.then(E, E);
    !c.cache && !b.cache || !1 === c.cache || "GET" !== c.method && "JSONP" !== c.method || (C = J(c.cache) ? c.cache : J(b.cache) ? b.cache : n);
    C && (I = C.get(q), D(I) ? I && B(I.then) ? I.then(s, s) : x(I) ? m(I[1], I[0], oa(I[2]), I[3]) : m(I, 200, {}, "OK") : C.put(q, L));
    A(I) && ((I = dd(c.url) ? e.cookies()[c.xsrfCookieName || b.xsrfCookieName] : u) && (N[c.xsrfHeaderName ||
    b.xsrfHeaderName] = I), d(c.method, q, f, l, N, c.timeout, c.withCredentials, c.responseType));
    return L
   }
   ...
   function r(a, b) {
    ...
    var c = [];
    Id(b, function (a, b) {
     null === a || A(a) || (x(a) || (a = [a]), q(a, function (a) {
      J(a) && (a = ea(a) ? a.toISOString() : $a(a));
      c.push(Ca(b) + "=" + Ca(a))
     }))
    });
   ...
   var n = f("$http"), s = [];
   q(c, function (a) {
    s.unshift(K(a) ? l.get(a) : l.invoke(a))
   });
   k.pendingRequests = [];
   (function (a) {
 ...
 function Pe() {
  this.$get = ["$browser", "$window", "$document", function (b, a, c) {
   return zf(b, yf, b.defer, a.angular.callbacks, c[0])
  }]
 }
 ...
 function zf(b, a, c, d, e) {
  ...
  return function (e, h, l, k, m, r, n, s) {
   function t() {
    p && p();
    H && H.abort()
   }
   ...
   if ("jsonp" == P(e)) {
    ...
    var p = f(h.replace("JSON_CALLBACK", "angular.callbacks." + v), v, function (a, b) {
     w(k, a, d[v].data, "", b);
     d[v] = F
    })
   } else {
    ...
    H.onload = function () {
     ...
     w(k, c, b, H.getAllResponseHeaders(), a)
    };
    e =
        function () {
         w(k, -1, null, null, "")
   ...
   if (0 < r)var Q = c(t, r); else r && B(r.then) && r.then(t)
  }
 }
   ...
   function g(f, g, s, t) {
    ...
    function v(a) {
     try {
      ...
      var c;
      if (t && !D(a))c = a; else if (null == a)c = ""; else {
       switch (typeof a) {
        case "string":
         break;
        case "number":
    ...
    t = !!t;
    for (var p, H, E = 0, Q = [], L = [], C = f.length, I = [], N = []; E < C;)if (-1 != (p = f.indexOf(b, E)) && -1 != (H = f.indexOf(a, p + h)))E !== p && I.push(w(f.substring(E, p))), E = f.substring(p + h, H), Q.push(E), L.push(c(E, v)), E = H + l, N.push(I.length), I.push(""); else {
     E !== C && I.push(w(f.substring(E)));
     break
    }
    if (s && 1 < I.length)throw dc("noconcat", f);
    if (!g || Q.length) {
     var q = function (a) {
     ...
     return z(function (a) {
      ...
      exp: f, expressions: Q, $$watchDelegate: function (a, b, c) {
       var d;
       return a.$watchGroup(L, function (c, e) {
        var f = q(c);
 ...
 function Ne() {
  this.$get = ["$rootScope", "$window", "$q", "$$q", function (b, a, c, d) {
   function e(e, h, l, k) {
    var m = a.setInterval, r = a.clearInterval, n = 0, s = D(k) && !k, t = (s ? d : c).defer(), w = t.promise;
    l = D(l) ? l : 0;
    w.then(null, null, e);
    w.$$intervalId = m(function () {
     t.notify(n++);
     0 < l && n >= l && (t.resolve(n), r(w.$$intervalId), delete f[w.$$intervalId]);
     s || b.$apply()
    }, h);
    f[w.$$intervalId] = t;
    return w
...
SHORTMONTH:"Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "),DAY:"Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "),SHORTDAY:"Sun Mon Tue Wed Thu Fri Sat".split(" "),AMPMS:["AM","PM"],medium:"MMM d, y h:mm:ss a","short":"M/d/yy h:mm a",fullDate:"EEEE, MMMM d, y",longDate:"MMMM d, y",mediumDate:"MMM d, y",shortDate:"M/d/yy",mediumTime:"h:mm:ss a",shortTime:"h:mm a",ERANAMES:["Before Christ","Anno Domini"],ERAS:["BC","AD"]},pluralCat:function(b){return 1===b?"one":"other"}}}}
 ...
 function ed(b, a) {
  ...
  a.$$host = c.hostname;
  a.$$port = aa(c.port) || Af[c.protocol] || null
 }
 ...
 function fc(b, a, c) {
  ...
  this.$$parse = function (b) {
   var c = ra(a, b);
   if (!K(c))throw Ib("ipthprfx", b, a);
   fd(c, this);
   this.$$path || (this.$$path = "/");
   this.$$compose()
  };
  this.$$compose = function () {
   var b = Qb(this.$$search), c = this.$$hash ? "#" + tb(this.$$hash) : "";
   this.$$url = ec(this.$$path) + (b ? "?" + b : "") + c;
 ...
 function gc(b, a, c) {
  ...
  this.$$parse = function (d) {
   ...
   A(e) || "#" !== e.charAt(0) ? this.$$html5 ? f = e : (f = "", A(e) && (b = d, this.replace())) : (f = ra(c, e), A(f) && (f = e));
   fd(f, this);
   d = this.$$path;
   var e = b, g = /^\/[A-Z]:(\/.*)/;
  ...
  this.$$compose = function () {
   var a = Qb(this.$$search), e = this.$$hash ? "#" + tb(this.$$hash) : "";
   this.$$url = ec(this.$$path) + (a ? "?" + a : "") + e;
 ...
 function gd(b, a, c) {
  ...
  this.$$parseLinkUrl = function (d, e) {
   if (e && "#" === e[0])return this.hash(e.slice(1)), !0;
   var f, g;
   b == Ea(d) ? f = d : (g = ra(a, d)) ? f = b + c + g : a === d +
   "/" && (f = a);
   f && this.$$parse(f);
   return !!f
  };
 ...
 function Qe() {
  ...
  this.html5Mode = function (b) {
   return Wa(b) ?
       (a.enabled = b, this) : J(b) ? (Wa(b.enabled) && (a.enabled = b.enabled), Wa(b.requireBase) && (a.requireBase = b.requireBase), Wa(b.rewriteLinks) && (a.rewriteLinks = b.rewriteLinks), this) : a
  };
  this.$get = ["$rootScope", "$browser", "$sniffer", "$rootElement", "$window", function (c, d, e, f, g) {
   ...
   var r = d.url(),
       n;
   if (a.enabled) {
    if (!m && a.requireBase)throw Ib("nobase");
    n = r.substring(0, r.indexOf("/", r.indexOf("//") + 2)) + (m || "/");
    m = e.history ? fc : gd
   } else n = Ea(r), m = gc;
   var s = n.substr(0, Ea(n).lastIndexOf("/") + 1);
   k = new m(n, s, "#" + b);
   k.$$parseLinkUrl(r, r);
   k.$$state = d.state();
   ...
   f.on("click", function (b) {
    if (a.rewriteLinks && !b.ctrlKey && !b.metaKey && !b.shiftKey && 2 != b.which && 2 != b.button) {
     for (var e = G(b.target); "a" !== ta(e[0]);)if (e[0] === f[0] || !(e = e.parent())[0])return;
     var h = e.prop("href"), l = e.attr("href") ||
         e.attr("xlink:href");
     J(h) && "[object SVGAnimatedString]" === h.toString() && (h = ya(h.animVal).href);
   ...
   Hb(k.absUrl()) != Hb(r) && d.url(k.absUrl(), !0);
   var w = !0;
   d.onUrlChange(function (a, b) {
    A(ra(s, a)) ? g.location.href = a : (c.$evalAsync(function () {
     var d = k.absUrl(), e = k.$$state, f;
     k.$$parse(a);
     k.$$state = b;
     f = c.$broadcast("$locationChangeStart",
         a, d, b, e).defaultPrevented;
     k.absUrl() === a && (f ? (k.$$parse(d), k.$$state = e, h(d, !1, e)) : (w = !1, l(d, e)))
    }), c.$$phase || c.$digest())
   });
   c.$watch(function () {
    var a = Hb(d.url()), b = Hb(k.absUrl()), f = d.state(), g = k.$$replace, n = a !== b || k.$$html5 && e.history && f !== k.$$state;
    if (w || n)w = !1, c.$evalAsync(function () {
 ...
 function ka(b, a) {
  if (b) {
   ...
   if (b.children && (b.nodeName || b.prop &&
       b.attr && b.find))throw ja("isecdom", a);
 ...
 function id(b, a, c, d, e, f, g) {
  ...
  var h = function (a) {
       return ka(a, f)
      }, l = g || Pa(b) ? h : na, k = g || Pa(a) ? h : na, m = g || Pa(c) ? h : na,
      r = g || Pa(d) ? h : na, n = g || Pa(e) ? h : na;
  return function (f, g) {
 ...
 function Cf(b, a, c) {
  var d = a.expensiveChecks, e = d ? Df : Ef, f = e[b];
  if (f)return f;
  var g = b.split("."), h = g.length;
  if (a.csp)f = 6 > h ? id(g[0], g[1], g[2], g[3], g[4], c, d) : function (a,
                                                                           b) {
   var e = 0, f;
   do f = id(g[e++], g[e++], g[e++], g[e++], g[e++], c, d)(a, b), b = u, a = f; while (e < h);
   return f
  }; else {
   var l = "";
   d && (l += "s = eso(s, fe);\nl = eso(l, fe);\n");
 ...
 function ic(b) {
  return B(b.valueOf) ? b.valueOf() : Ff.call(b)
 }
 ...
 function Se() {
  ...
  this.$get = ["$filter", "$sniffer", function (c, d) {
   ...
   function g(a, b) {
    return null == a || null == b ? a === b : "object" === typeof a && (a = ic(a), "object" === typeof a) ?
        !1 : a === b || a !== a && b !== b
   }
   ...
   var n = {csp: d.csp, expensiveChecks: !1}, s = {csp: d.csp, expensiveChecks: !0};
   return function (d, f, g) {
    ...
    switch (typeof d) {
     case "string":
      ...
      var Q = g ? a : b;
      p = Q[E];
      p || (":" === d.charAt(0) && ":" === d.charAt(1) && (q = !0, d = d.substring(2)), g = g ? s : n, p = new jc(g), p = (new lb(p, c, g)).parse(d), p.constant ? p.$$watchDelegate =
          m : q ? (p = e(p), p.$$watchDelegate = p.literal ? k : l) : p.inputs && (p.$$watchDelegate = h), Q[E] = p);
      return r(p, f);
     case "function":
      return r(d, f);
     default:
 ...
 function Te() {
  ...
  var a = 10, c = y("$rootScope"), d = null, e = null;
  ...
  this.$get = ["$injector", "$exceptionHandler", "$parse", "$browser", function (f, g, h, l) {
   ...
   m.prototype = {
    constructor: m, $new: function (a, c) {
     ...
     function c(a) {
      ...
      var b, d, g, h;
      if (!A(e)) {
       if (J(e))if (Sa(e))for (f !== n && (f = n, s = f.length = 0, k++), a = e.length, s !== a && (k++, f.length = s = a), b = 0; b < a; b++)h = f[b], g = e[b], d = h !== h && g !== g, d || h === g || (k++, f[b] = g); else {
        f !== r && (f = r = {}, s = 0, k++);
        a = 0;
        for (b in e)e.hasOwnProperty(b) && (a++, g = e[b], h = f[b], b in f ? (d = h !== h && g !== g, d || h === g || (k++, f[b] = g)) : (s++, f[b] = g, k++));
        if (s > a)for (b in k++, f)e.hasOwnProperty(b) || (s--, delete f[b])
       } else f !==
       e && (f = e, k++);
       return k
      }
     ...
     c.$stateful = !0;
     var d = this, e, f, g, l = 1 < b.length, k = 0, m = h(a, c), n = [], r = {}, p = !0, s = 0;
     return this.$watch(m, function () {
      p ? (p = !1, b(e, e, d)) : b(e, g, d);
      if (l)if (J(e))if (Sa(e)) {
       g = Array(e.length);
       for (var a = 0; a < e.length; a++)g[a] = e[a]
      } else for (a in g = {}, e)vc.call(e, a) && (g[a] = e[a]); else g = e
     })
    }, $digest: function () {
     var b, f, h, k, m, n, q = a, w, O = [], E, u;
     r("$digest");
     l.$$checkUrlChange();
     this === v && null !== e && (l.defer.cancel(e), t());
     d = null;
     do {
      n = !1;
      for (w = this; p.length;) {
       try {
        u = p.shift(), u.scope.$eval(u.expression,
            u.locals)
       } catch (D) {
        g(D)
       }
      ...
      a:do {
       if (k = w.$$watchers)for (m = k.length; m--;)try {
        if (b = k[m])if ((f = b.get(w)) !== (h = b.last) && !(b.eq ? fa(f, h) : "number" === typeof f && "number" === typeof h && isNaN(f) && isNaN(h)))n = !0, d = b, b.last = b.eq ? Ba(f, null) : f, b.fn(f, h === s ? f : h, w), 5 > q && (E = 4 - q, O[E] || (O[E] = []), O[E].push({
       ...
       if (!(k = w.$$childHead || w !== this && w.$$nextSibling))for (; w !== this && !(k = w.$$nextSibling);)w = w.$parent
      } while (w =
          k);
      if ((n || p.length) && !q--)throw v.$$phase = null, c("infdig", a, O);
     } while (n || p.length);
     ...
     v.$$phase || p.length || l.defer(function () {
      p.length && v.$digest()
     });
     p.push({
   ...
   var v = new m, p = v.$$asyncQueue = [], H = v.$$postDigestQueue = [], E = v.$$applyAsyncQueue =
       [];
   return v
  }]
 }
 ...
 function Xe() {
  ...
  this.$get = ["$injector", function (c) {
   function d(a, b) {
    return "self" === a ? dd(b) : !!a.exec(b.href)
   }
   ...
   return {
    trustAs: function (a, b) {
     ...
     if (c === la.RESOURCE_URL) {
      var g = ya(e.toString()), r, n, s = !1;
      r = 0;
      for (n = b.length; r < n; r++)if (d(b[r], g)) {
       s = !0;
       break
      }
      if (s)for (r = 0, n = a.length; r < n; r++)if (d(a[r], g)) {
       s = !1;
       break
      }
      if (s)return e;
 ...
 function Ye() {
  this.$get = ["$window", "$document", function (b, a) {
   var c = {}, d = aa((/android (\d+)/.exec(P((b.navigator || {}).userAgent)) || [])[1]), e = /Boxee/i.test((b.navigator || {}).userAgent), f = a[0] || {}, g, h = /^(Moz|webkit|ms)(?=[A-Z])/, l = f.body && f.body.style, k = !1, m = !1;
   if (l) {
    for (var r in l)if (k =
            h.exec(r)) {
     g = k[0];
    ...
    !d || k && m || (k = K(f.body.style.webkitTransition), m = K(f.body.style.webkitAnimation))
   }
   return {
    history: !(!b.history || !b.history.pushState || 4 > d || e), hasEvent: function (a) {
     ...
     return c[a]
    }, csp: cb(), vendorPrefix: g, transitions: k, animations: m,
    android: d
   }
  }]
 }
   ...
   return {
    findBindings: function (a, b, c) {
     ...
     q(a, function (a) {
      ...
      d && q(d, function (d) {
       c ? (new RegExp("(^|\\s)" + kd(b) + "(\\s|\\||$)")).test(d) && g.push(a) : -1 != d.indexOf(b) && g.push(a)
      })
     });
     return g
 ...
 function bf() {
  this.$get = ["$rootScope", "$browser", "$q", "$$q", "$exceptionHandler", function (b, a, c, d, e) {
   function f(f, l, k) {
    var m = D(k) && !k, r = (m ? d : c).defer(), n = r.promise;
    l = a.defer(function () {
     try {
      r.resolve(f())
     } catch (a) {
 ...
 function dd(b) {
  b = K(b) ? ya(b) : b;
  return b.protocol === md.protocol && b.host === md.host
 }
 ...
 function Ha(b, a, c, d, e) {
  var f = null !==
  b ? typeof b : "null", g = null !== a ? typeof a : "null";
  if ("string" === g && "!" === a.charAt(0))return !Ha(b, a.substring(1), c, d);
  if (x(b))return b.some(function (b) {
   return Ha(b, a, c, d)
  });
  switch (f) {
   case "object":
    ...
    if ("object" === g) {
     for (h in a)if (e = a[h], !B(e) && !A(e) && (f = "$" === h, !Ha(f ? b : b[h], e, c, f, f)))return !1;
     return !0
    }
    return c(b, a);
   case "function":
 ...
 function nd(b) {
  ...
  return function (b,
   ...
   return null == b ? b : rd(b, a.PATTERNS[1], a.GROUP_SEP, a.DECIMAL_SEP, e).replace(/\u00A4/g, d)
  }
 }
 ...
 function pd(b) {
  var a = b.NUMBER_FORMATS;
  return function (b, d) {
   return null == b ? b : rd(b, a.PATTERNS[0], a.GROUP_SEP, a.DECIMAL_SEP, d)
  }
 }
 ...
 function rd(b, a, c, d, e) {
  ...
  if (k)0 < e && 1 > b && (h = b.toFixed(e),
      b = parseFloat(h)); else {
   g = (g.split(sd)[1] || "").length;
   A(e) && (e = Math.min(Math.max(a.minFrac, g), a.maxFrac));
   b = +(Math.round(+(b.toString() + "e" + e)).toString() + "e" + -e);
   var g = ("" + b).split(sd), k = g[0], g = g[1] || "", r = 0, n = a.lgSize, s = a.gSize;
   if (k.length >= n + s)for (r = k.length - n, m = 0; m < r; m++)0 === (r - m) % s && 0 !== m && (h += c), h += k.charAt(m);
 ...
 function Lb(b, a) {
  return function (c, d) {
   var e = c["get" + b](), f = wb(a ? "SHORT" + b : b);
   return d[f][e]
  }
 }
 ...
 function ud(b) {
  return function (a) {
   var c = td(a.getFullYear());
   a = +new Date(a.getFullYear(),
           a.getMonth(), a.getDate() + (4 - a.getDay())) - +c;
 ...
 function od(b) {
  ...
  return function (c, e, f) {
   ...
   K(c) && (c = Nf.test(c) ? aa(c) : a(c));
   U(c) && (c = new Date(c));
   if (!ea(c))return c;
   for (; e;)(k = Of.exec(e)) ? (h = Ya(h, k, 1), e = h.pop()) : (h.push(e), e = null);
 ...
 function Jf() {
  return function (b, a) {
   U(b) && (b = b.toString());
   return x(b) || K(b) ? (a = Infinity === Math.abs(Number(a)) ? Number(a) : aa(a)) ? 0 < a ? b.slice(0, a) : b.slice(a) : K(b) ? "" : [] : b
  }
 }
 ...
 function qd(b) {
  return function (a, c, d) {
   ...
   function g(a) {
    return null === a ? "null" : "function" === typeof a.valueOf &&
    (a = a.valueOf(), f(a)) || "function" === typeof a.toString && (a = a.toString(), f(a)) ? a : ""
   }
 ...
 function vd(b, a, c, d, e) {
  var f = this, g = [], h = f.$$parentForm = b.parent().controller("form") || Mb;
  f.$error = {};
  f.$$success = {};
  f.$pending = u;
  ...
  f.$setPristine = function () {
   d.setClass(b, Ra, Nb + " ng-submitted");
   f.$dirty = !1;
   f.$pristine = !0;
   f.$submitted = !1;
   q(g, function (a) {
 ...
 function nb(b, a, c,
  ...
  return function (e, f, g, h, l, k, m) {
   ...
   function n(a) {
    return D(a) ? ea(a) ? a : c(a) : u
   }

   xd(e, f, g, h);
   mb(e, f, g, h, l, k);
   var s = h && h.$options && h.$options.timezone, t;
   h.$$parserName = b;
   h.$parsers.push(function (b) {
    return h.$isEmpty(b) ? null : a.test(b) ? (b = c(b, t), "UTC" === s && b.setMinutes(b.getMinutes() - b.getTimezoneOffset()), b) : u
   });
   h.$formatters.push(function (a) {
    if (a && !ea(a))throw ob("datefmt", a);
    if (r(a)) {
     if ((t = a) && "UTC" === s) {
      var b = 6E4 * t.getTimezoneOffset();
 ...
 function yd(b, a,
  ...
  if (D(d)) {
   b = b(d);
   if (!b.constant)throw ob("constexpr", c, d);
   return b(a)
  }
  return e
 }
     ...
     function k(b) {
      if (!0 === a || f.$index % 2 === a) {
       ...
       if (!m) {
        ...
        var t = e(m), s = d(k, t), k = d(t, k), s = l(s, 1), k = l(k, -1);
 ...
 function wd(b) {
  ...
  f[zd] = !(f[pb] = e.hasClass(pb));
  d.$setValidity = function (b, e, f) {
   e === u ? (d.$pending || (d.$pending = {}), g(d.$pending, b, f)) : (d.$pending && h(d.$pending, b, f), Ad(d.$pending) && (d.$pending =
       u));
   Wa(e) ? e ? (h(d.$error, b, f), g(d.$$success, b, f)) : (g(d.$error, b, f), h(d.$$success, b, f)) : (h(d.$error, b, f), h(d.$$success, b, f));
   d.$pending ? (a(Bd, !0), d.$valid = d.$invalid = u, c("", null)) : (a(Bd, !1), d.$valid = Ad(d.$error), d.$invalid = !d.$valid, c("", d.$valid));
 ...
 var Rf = /^\/(.+)\/([a-z]*)$/, P = function (b) {
      return K(b) ? b.toLowerCase() : b
     }, vc = Object.prototype.hasOwnProperty,
     wb = function (b) {
      return K(b) ? b.toUpperCase() : b
     }, Qa, G, pa, Za = [].slice, tf = [].splice, Sf = [].push, Aa = Object.prototype.toString, Ja = y("ng"), ba = S.angular || (S.angular = {}), db, sb = 0;
 Qa = W.documentMode;
 F.$inject = [];
 na.$inject = [];
 var x = Array.isArray, T = function (b) {
  return K(b) ? b.trim() : b
 }, kd = function (b) {
  return b.replace(/([-()\[\]{}+?*.$\^|,:#<!\\])/g, "\\$1").replace(/\x08/g, "\\x08")
 }, cb = function () {
  if (D(cb.isActive_))return cb.isActive_;
 ...
 }, ub = ["ng-", "data-ng-", "ng:", "x-ng-"], Qd = /[A-Z]/g, yc = !1, Rb, ma = 1, ab = 3, Ud = {
  full: "1.3.19",
  major: 1,
  minor: 3,
  dot: 19,
 ...
 var gf = /([\:\-\_]+(.))/g, hf = /^moz([A-Z])/, Tf = {
      mouseleave: "mouseout",
      mouseenter: "mouseover"
     }, Ub = y("jqLite"), lf = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, Tb = /<|&#?\w+;/, jf = /<([\w:]+)/, kf = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi,
     ha = {
 ...
 var Ka = R.prototype = {
  ready: function (b) {
   ...
   var c = !1;
   "complete" === W.readyState ? setTimeout(a) : (this.on("DOMContentLoaded", a), R(S).on("load", a))
  },
  toString: function () {
   var b = [];
   q(this, function (a) {
   ...
   return 0 <= b ? G(this[b]) : G(this[this.length + b])
 ...
 var Rc = {ngMinlength: "minlength", ngMaxlength: "maxlength", ngMin: "min", ngMax: "max", ngPattern: "pattern"};
 q({data: Wb, removeData: zb}, function (b, a) {
  R[a] = b
 });
 q({
  data: Wb, inheritedData: Fb, scope: function (b) {
   return G.data(b, "$scope") || Fb(b.parentNode || b, ["$isolateScope", "$scope"])
  }, isolateScope: function (b) {
   return G.data(b, "$isolateScope") || G.data(b, "$isolateScopeNoTemplate")
   ...
   a = eb(a);
   if (D(c))b.style[a] = c; else return b.style[a]
  }, attr: function (b, a, c) {
   var d = b.nodeType;
   if (d !==
       ab && 2 !== d && 8 !== d)if (d = P(a), Gb[d])if (D(c))c ? (b[a] = !0, b.setAttribute(a, d)) : (b[a] = !1, b.removeAttribute(d)); else return b[a] || (b.attributes.getNamedItem(a) || F).specified ? d : u; else if (D(c))b.setAttribute(a, c); else if (b.getAttribute)return b = b.getAttribute(a, 2), null === b ? u : b
  }, prop: function (b, a, c) {
  ...
  R.prototype[a] = function (a, d) {
   ...
   if (b !== Nc && (2 == b.length && b !== Cb && b !== Mc ? a : d) === u) {
    if (J(a)) {
 ...
 q({
  removeData: zb, on: function a(c, d, e, f) {
   if (D(f))throw Ub("onargs");
   if (Ic(c)) {
    var g = Ab(c, !0);
    f = g.events;
    var h = g.handle;
   ...
   if (h = (h = h && h.events) && h[g])e = {
    ...
    stopPropagation: F, type: g, target: a
   }, c.type && (e = z(e, c)), c = oa(h), f = d ? [e].concat(d) : [e], q(c, function (c) {
    e.isImmediatePropagationStopped() || c.apply(a, f)
   })
  }
 }, function (a, c) {
  R.prototype[c] = function (c, e, f) {
   for (var g, h = 0, l = this.length; h < l; h++)A(g) ? (g = a(this[h], c, e, f), D(g) && (g = G(g))) : Kc(g, a(this[h], c, e, f));
   return D(g) ? g : this
  };
 ...
 var Tc = /^function\s*[^\(]*\(\s*([^\)]*)\)/m, Uf = /,/, Vf = /^\s*(_?)(\S+?)\1\s*$/, Sc = /((\/\/.*$)|(\/\*[\s\S]*?\*\/))/mg, Da = y("$injector");
 bb.$$annotate = function (a, c, d) {
  ...
  if ("function" === typeof a) {
   if (!(e = a.$inject)) {
    e = [];
    if (a.length) {
     if (c)throw K(d) && d || (d = a.name || qf(a)), Da("strictdi", d);
     c = a.toString().replace(Sc, "");
     c = c.match(Tc);
     q(c[1].split(Uf), function (a) {
  ...
  } else x(a) ? (c = a.length - 1, La(a[c],
      "fn"), e = a.slice(0, c)) : La(a, "fn", !0);
  return e
 };
 var Wf = y("$animate"), Ge = ["$provide", function (a) {
  this.$$selectors = {};
 ...
 var Vc = /^((?:x|data)[\:\-_])/i, uf = y("$controller"), $c = "application/json", cc = {"Content-Type": $c + ";charset=utf-8"}, wf = /^\[|^\{(?!\{)/, xf = {
      "[": /]$/,
      "{": /}$/
     }, vf = /^\)\]\}',?\n/, dc = y("$interpolate"), Xf = /^([^\?#]*)(\?([^#]*))?(#(.*))?$/,
     Af = {http: 80, https: 443, ftp: 21}, Ib = y("$location"), Yf = {
      $$html5: !1, $$replace: !1, absUrl: Jb("$$absUrl"), url: function (a) {
       ...
       this.hash(c[5] || "");
       return this
      }, protocol: Jb("$$protocol"), host: Jb("$$host"), port: Jb("$$port"), path: hd("$$path", function (a) {
       a = null !== a ? a.toString() : "";
       ...
       switch (arguments.length) {
        case 0:
         return this.$$search;
        case 1:
         if (K(a) || U(a))a = a.toString(), this.$$search = uc(a); else if (J(a))a = Ba(a, {}), q(a, function (c, e) {
          null == c && delete a[e]
         }), this.$$search = a; else throw Ib("isrcharg");
         break;
        default:
 ...
 q([gd, gc, fc], function (a) {
  a.prototype = Object.create(Yf);
  a.prototype.state = function (c) {
   if (!arguments.length)return this.$$state;
   if (a !== fc || !this.$$html5)throw Ib("nostate");
   this.$$state = A(c) ? null : c;
   return this
  }
 });
 var ja = y("$parse"), Zf = Function.prototype.call, $f = Function.prototype.apply, ag = Function.prototype.bind, qb = ga();
 q({
  "null": function () {
   return null
  }, "true": function () {
 ...
 jc.prototype = {
  constructor: jc, lex: function (a) {
   ...
   for (this.tokens = []; this.index < this.text.length;)if (a = this.text.charAt(this.index), '"' === a || "'" === a)this.readString(a); else if (this.isNumber(a) ||
    ...
    var c = a + this.peek(), d = c + this.peek(2), e = rb[c], f = rb[d];
    rb[a] || e || f ? (a = f ? d : e ? c : a, this.tokens.push({
     index: this.index,
     text: a,
     operator: !0
   ...
   d = d || this.index;
   c = D(c) ? "s " + c + "-" + this.index + " [" + this.text.substring(c,
       d) + "]" : " " + d;
   ...
   for (var d = "", e = a, f = !1; this.index < this.text.length;) {
    ...
    this.throwError("Invalid unicode escape [\\u" + f + "]"), this.index += 4, d += String.fromCharCode(parseInt(f, 16))) : d += bg[g] || g, f = !1; else if ("\\" === g)f = !0; else {
     if (g === a) {
      this.index++;
 ...
 lb.prototype = {
  constructor: lb, parse: function (a) {
   ...
   var a;
   this.expect("(") ? (a = this.filterChain(), this.consume(")")) : this.expect("[") ? a = this.arrayDeclaration() : this.expect("{") ? a = this.object() : this.peek().identifier && this.peek().text in qb ? a = qb[this.consume().text] : this.peek().identifier ? a = this.identifier() : this.peek().constant ? a = this.constant() : this.throwError("not a primary expression",
       this.peek());
   ...
   return Cf(a, this.options, this.text)
  }, constant: function () {
   ...
   return z(function (f, h) {
    ...
    return c(l)
   }, {constant: !c.$stateful && f.every(hc), inputs: !c.$stateful && f})
  }, expression: function () {
   ...
   return z(function (c, d) {
    ...
    return e
   }, {literal: !0, constant: a.every(hc), inputs: a})
  }, object: function () {
   var a = [], c = [];
   if ("}" !== this.peekToken().text) {
    do {
   ...
   return z(function (d, f) {
    ...
    return g
   }, {literal: !0, constant: c.every(hc), inputs: c})
  }
 };
 var Ef = ga(), Df = ga(), Ff = Object.prototype.valueOf, za = y("$sce"), la = {
  HTML: "html",
  CSS: "css",
  URL: "url",
  RESOURCE_URL: "resourceUrl",
  JS: "js"
 }, da = y("$compile"), X = W.createElement("a"), md = ya(S.location.href);
 Hc.$inject = ["$provide"];
 nd.$inject = ["$locale"];
 pd.$inject = ["$locale"];
 var sd = ".", Pf = {
 ...
 }, Of = /((?:[^yMdHhmsaZEwG']+)|(?:'(?:[^']|'')*')|(?:E+|y+|M+|d+|H+|h+|m+|s+|a|Z|G+|w+))(.*)/, Nf = /^\-?\d+$/;
 od.$inject = ["$locale"];
 var Kf = ca(P), Lf = ca(wb);
 qd.$inject = ["$parse"];
 var Xd = ca({
 ...
 var Mb = {
  $addControl: F, $$renameControl: function (a, c) {
   a.$name = c
  }, $removeControl: F, $setValidity: F, $setDirty: F, $setPristine: F, $setSubmitted: F
 };
 vd.$inject = ["$element", "$attrs", "$scope", "$animate", "$interpolate"];
 var Cd = function (a) {
      return ["$timeout",
       function (c) {
        return {
         name: "form", restrict: a ? "EAC" : "E", controller: vd, compile: function (d, e) {
          d.addClass(Ra).addClass(pb);
          ...
          return {
           pre: function (a, d, e, k) {
            ...
            f && (kb(a, null, k.$name, k, k.$name), e.$observe(f,
                function (c) {
                 k.$name !== c && (kb(a, null, k.$name, u, k.$name), r.$$renameControl(k, c), kb(a, null, k.$name, k, k.$name))
                }));
            d.on("$destroy", function () {
             r.$removeControl(k);
             f && kb(a, null, e[f], u, k.$name);
             z(k, Mb)
            })
           }
          }
     ...
     }, Yd = Cd(), ke = Cd(!0), Qf = /\d{4}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d:[0-5]\d\.\d+([+-][0-2]\d:[0-5]\d|Z)/, cg = /^(ftp|http|https):\/\/(\w+:{0,1}\w*@)?(\S+)(:[0-9]+)?(\/|\/([\w#!:.?+=&%@!\-\/]))?$/, dg = /^[a-z0-9!#$%&'*+\/=?^_`{|}~.-]+@[a-z0-9]([a-z0-9-]*[a-z0-9])?(\.[a-z0-9]([a-z0-9-]*[a-z0-9])?)*$/i, eg = /^\s*(\-|\+)?(\d+|(\d*(\.\d*)))\s*$/,
     Dd = /^(\d{4})-(\d{2})-(\d{2})$/, Ed = /^(\d{4})-(\d\d)-(\d\d)T(\d\d):(\d\d)(?::(\d\d)(\.\d{1,3})?)?$/, nc = /^(\d{4})-W(\d\d)$/, Fd = /^(\d{4})-(\d\d)$/, Gd = /^(\d\d):(\d\d)(?::(\d\d)(\.\d{1,3})?)?$/, Hd = {
      text: function (a, c, d, e, f, g) {
       mb(a, c, d, e, f, g);
       lc(e)
      },
      date: nb("date", Dd, Ob(Dd, ["yyyy", "MM", "dd"]), "yyyy-MM-dd"),
      "datetime-local": nb("datetimelocal", Ed, Ob(Ed, "yyyy MM dd HH mm ss sss".split(" ")), "yyyy-MM-ddTHH:mm:ss.sss"),
      time: nb("time", Gd, Ob(Gd, ["HH", "mm", "ss", "sss"]), "HH:mm:ss.sss"),
      week: nb("week", nc, function (a,
                                     c) {
       if (ea(a))return a;
       if (K(a)) {
        nc.lastIndex = 0;
        var d = nc.exec(a);
        if (d) {
         var e = +d[1], f = +d[2], g = d = 0, h = 0, l = 0, k = td(e), f = 7 * (f - 1);
      ...
      month: nb("month", Fd, Ob(Fd, ["yyyy", "MM"]), "yyyy-MM"),
      number: function (a, c, d, e, f, g) {
       xd(a, c, d, e);
       mb(a, c, d, e, f, g);
       e.$$parserName = "number";
       e.$parsers.push(function (a) {
        return e.$isEmpty(a) ? null : eg.test(a) ? parseFloat(a) : u
       });
       e.$formatters.push(function (a) {
        if (!e.$isEmpty(a)) {
         if (!U(a))throw ob("numfmt",
             a);
         a = a.toString()
        }
        return a
      ...
      checkbox: function (a, c, d, e, f, g, h, l) {
       var k = yd(l, a, "ngTrueValue", d.ngTrueValue,
           !0), m = yd(l, a, "ngFalseValue", d.ngFalseValue, !1);
       c.on("click", function (a) {
      ...
      reset: F,
      file: F
     }, Bc = ["$browser", "$sniffer", "$filter", "$parse", function (a, c, d, e) {
      return {
       restrict: "E", require: ["?ngModel"], link: {
        pre: function (f, g, h, l) {
         l[0] && (Hd[P(h.type)] || Hd.text)(f, g,
             h, l[0], c, a, d, e)
        }
       }
      }
     }], fg = /^(true|false|\d+)$/, Ce = function () {
      return {
       restrict: "A", priority: 100, compile: function (a, c) {
        return fg.test(c.ngValue) ? function (a, c, f) {
     ...
     }), fe = mc("", !0), he = mc("Odd", 0), ge = mc("Even", 1), ie = Ia({
 ...
 q("click dblclick mousedown mouseup mouseover mouseout mousemove mouseenter mouseleave keydown keyup keypress submit focus blur copy cut paste".split(" "),
     function (a) {
      var c = wa("ng-" + a);
      Gc[c] = ["$parse", "$rootScope", function (d, e) {
       return {
        restrict: "A", compile: function (f, g) {
         ...
         return function (c, d) {
          d.on(a, function (d) {
           ...
           gg[a] && e.$$phase ? c.$evalAsync(f) : c.$apply(f)
          })
         }
        }
       }
 ...
 var me = ["$animate", function (a) {
  return {
   ...
   link: function (c, d, e, f, g) {
    ...
    c.$watch(e.ngIf, function (c) {
     c ? l || g(function (c, f) {
      l = f;
      c[c.length++] = W.createComment(" end ngIf: " +
          e.ngIf + " ");
      h = {clone: c};
      a.enter(c, d.parent(), d)
     }) : (k && (k.remove(), k = null), l && (l.$destroy(), l = null), h && (k = vb(h.clone), a.leave(k).then(function () {
      k = null
     }), h = null))
    })
   }
  }
 }], ne = ["$templateRequest", "$anchorScroll", "$animate", function (a, c, d) {
  return {
   restrict: "ECA", priority: 400, terminal: !0, transclude: "element", controller: ba.noop, compile: function (e, f) {
    var g = f.ngInclude || f.src, h = f.onload || "", l = f.autoscroll;
    return function (e, f, q, n, s) {
     var t = 0, w, u, p, H = function () {
      u && (u.remove(), u = null);
      w && (w.$destroy(), w = null);
      p &&
     ...
     e.$watch(g, function (g) {
      ...
      g ? (a(g, !0).then(function (a) {
       if (r === t) {
        ...
        a = s(c, function (a) {
         H();
         d.enter(a, null, f).then(q)
        });
        w = c;
        p = a;
        w.$emit("$includeContentLoaded", g);
        e.$eval(h)
       }
      }, function () {
       r === t && (H(), e.$emit("$includeContentError", g))
      }), e.$emit("$includeContentRequested", g)) : (H(), n.template = null)
     })
    }
   }
  }
  ...
  return {
   ...
   link: function (c, d, e, f) {
    /SVG/.test(d[0].toString()) ? (d.empty(), a(Jc(f.template, W).childNodes)(c, function (a) {
     d.append(a)
 ...
 }, pb = "ng-valid", zd = "ng-invalid", Ra = "ng-pristine", Nb = "ng-dirty", Bd = "ng-pending", ob = y("ngModel"), hg = ["$scope", "$exceptionHandler", "$attrs", "$element", "$parse", "$animate", "$timeout", "$rootScope", "$q", "$interpolate", function (a, c, d, e, f, g, h, l, k, m) {
  ...
  var r = f(d.ngModel), n = r.assign, s = r, t = n, w = null, v, p = this;
  this.$$setOptions = function (a) {
   if ((p.$options = a) && a.getterSetter) {
    ...
    t = function (a, c) {
     B(r(a)) ? g(a, {$$$p: p.$modelValue}) : n(a,
         p.$modelValue)
    }
   } else if (!r.assign)throw ob("nonassign", d.ngModel, ua(e));
  };
  this.$render = F;
  this.$isEmpty = function (a) {
   return A(a) || "" === a || null === a || a !== a
  };
  var H = e.inheritedData("$formController") || Mb, E = 0;
  wd({
  ...
  this.$$runValidators = function (a, c, d) {
   ...
   function f() {
    ...
    q(p.$asyncValidators, function (f, h) {
     var k = f(a, c);
     if (!k || !B(k.then))throw ob("$asyncValidators", k);
     g(h, u);
   ...
   (function () {
    ...
    if (v === u)g(a, null); else return v || (q(p.$validators, function (a, c) {
     g(c, null)
  ...
  this.$$parseAndValidate = function () {
   ...
   if (v = A(c) ? u : !0)for (var d = 0; d < p.$parsers.length; d++)if (c = p.$parsers[d](c), A(c)) {
    v = !1;
    break
   }
   U(p.$modelValue) && isNaN(p.$modelValue) && (p.$modelValue = s(a));
  ...
  this.$$debounceViewValueCommit = function (c) {
   var d = 0, e = p.$options;
   e && D(e.debounce) && (e = e.debounce, U(e) ? d = e : U(e[c]) ? d = e[c] : U(e["default"]) && (d = e["default"]));
   h.cancel(w);
   d ? w = h(function () {
    p.$commitViewValue()
  ...
  a.$watch(function () {
   ...
   if (c !== p.$modelValue && (p.$modelValue === p.$modelValue || c === c)) {
    ...
    p.$viewValue !== f && (p.$viewValue = p.$$lastCommittedViewValue = f, p.$render(), p.$$runValidators(c, f, F))
   }
   return c
  })
  ...
  return {
   ...
   priority: 1,
   compile: function (c) {
    c.addClass(Ra).addClass("ng-untouched").addClass(pb);
    return {
 ...
 }], ig = /(\s+|^)default(\s+|$)/, De = function () {
  return {
   restrict: "A",
   controller: ["$scope", "$attrs", function (a, c) {
    var d = this;
    this.$options = a.$eval(c.ngModelOptions);
    this.$options.updateOn !== u ? (this.$options.updateOnDefault = !1, this.$options.updateOn = T(this.$options.updateOn.replace(ig, function () {
     d.$options.updateOnDefault = !0;
     return " "
    }))) : this.$options.updateOnDefault = !0
   }]
  }
 }, pe = Ia({terminal: !0, priority: 1E3}), qe = ["$locale", "$interpolate", function (a, c) {
  ...
  return {
   restrict: "EA", link: function (f, g, h) {
    ...
    var k = h.count,
        m = h.$attr.when && g.attr(h.$attr.when), r = h.offset || 0, n = f.$eval(m) || {}, s = {}, m = c.startSymbol(), t = c.endSymbol(), w = m + k + "-" + r + t, u = ba.noop, p;
    q(h, function (a, c) {
     var d = e.exec(c);
     d && (d = (d[1] ? "-" : "") + P(d[2]), n[d] = g.attr(h.$attr[c]))
    });
    q(n, function (a, e) {
     s[e] = c(a.replace(d, w))
    });
    f.$watch(k, function (c) {
     ...
     c === p || d && isNaN(p) || (u(), u = f.$watch(s[c], l), p = c)
    })
   }
  }
 }], re = ["$parse", "$animate", function (a, c) {
  var d = y("ngRepeat"), e = function (a, c, d, e, k, m, q) {
   a[d] = e;
   k && (a[k] =
       m);
   a.$index = c;
  ...
  return {
   ...
   compile: function (f, g) {
    ...
    if (!k)throw d("iexp", h);
    var m = k[1], r = k[2], n = k[3], s = k[4], k = m.match(/^(?:(\s*[\$\w]+)|\(\s*([\$\w]+)\s*,\s*([\$\w]+)\s*\))$/);
    ...
    return function (a, f, g, k, m) {
     ...
     a.$watchCollection(r, function (g) {
      var k, r, v = f[0], I, A = ga(), z, y, F, N, B, x, J;
      n && (a[n] = g);
      if (Sa(g))B =
          g, r = p || D; else {
       r = p || E;
       B = [];
       for (J in g)g.hasOwnProperty(J) && "$" != J.charAt(0) && B.push(J);
       B.sort()
      }
      z = B.length;
      J = Array(z);
      for (k = 0; k < z; k++)if (y = g === B ? k : B[k], F = g[y], N = r(y, F, k), s[N])x = s[N], delete s[N], A[N] = x, J[k] = x; else {
       if (A[N])throw q(J, function (a) {
        a && a.scope && (s[a.id] = a)
       }), d("dupes", h, N, F);
       J[k] = {id: N, scope: u, clone: u};
       A[N] = !0
      }
      for (I in s) {
       x = s[I];
      ...
      for (k = 0; k < z; k++)if (y = g === B ? k : B[k], F = g[y], x = J[k], x.scope) {
       I =
           v;
       do I = I.nextSibling; while (I && I.$$NG_REMOVED);
       x.clone[0] != I && c.move(vb(x.clone), null, G(v));
       v = x.clone[x.clone.length - 1];
       e(x.scope, k, t, F, w, y, z)
      } else m(function (a, d) {
       x.scope = d;
       var f = l.cloneNode(!1);
       a[a.length++] = f;
  ...
  restrict: "EAC", link: function (a, c, d, e, f) {
   if (!f)throw y("ngTransclude")("orphan", ua(c));
   f(function (a) {
    c.empty();
    c.append(a)
   })
 ...
 }], jg = y("ngOptions"), xe = ca({restrict: "A", terminal: !0}), $d = ["$compile", "$parse", function (a, c) {
   ...
   restrict: "E", require: ["select", "?ngModel"], controller: ["$element", "$scope", "$attrs", function (a,
    ...
    function r(e, f, g) {
     ...
     function k(a) {
      ...
      } else c = new fb(a); else K && (a = h(K, null, a));
      return function (d, e) {
       var f;
       f = K ? K : B ? B : C;
       return s ? D(c.remove(h(f, d, e))) : a === h(f, d, e)
      }
     }
     ...
     function r() {
      ...
      t = g.$viewValue;
      u = L(e) || [];
      var y = G ? Object.keys(u).sort() : u, x, B, F, C, S = {};
      v = k(t);
      var O = !1, T, U;
      P = {};
      for (C = 0; F = y.length, C < F; C++) {
       x = C;
       if (G && (x = y[C], "$" === x.charAt(0)))continue;
       B = u[x];
       d = h(J, x, B) || "";
       ...
       U = K ? K(e, R) : G ? y[C] : C;
       K && (P[U] = x);
       l.push({id: U, label: B, selected: d})
      }
      s || (w || null === t ? a[""].unshift({id: "", label: "", selected: !O}) : O || a[""].unshift({
       id: "?",
       label: "", selected: !0
      }));
      x = 0;
      for (y = c.length; x < y; x++) {
       d = c[x];
       l = a[d];
       Q.length <= x ? (t = {
        element: E.clone().attr("label", d),
        label: l.label
       }, u = [t], Q.push(u), f.append(t.element)) : (u = Q[x], t = u[0], t.label != d && t.element.attr("label", t.label = d));
       O = null;
       C = 0;
       for (F = l.length; C < F; C++)d = l[C], (v = u[C + 1]) ? (O = v.element, v.label !== d.label && (m(S, v.label, !1), m(S, d.label, !0), O.text(v.label = d.label), O.prop("label", v.label)), v.id !== d.id && O.val(v.id = d.id), O[0].selected !== d.selected && (O.prop("selected", v.selected = d.selected), Qa && O.prop("selected",
           v.selected))) : ("" === d.id && w ? T = w : (T = A.clone()).val(d.id).prop("selected", d.selected).attr("selected", d.selected).prop("label", d.label).text(d.label), u.push(v = {
        element: T,
        label: d.label,
        id: d.id,
        selected: d.selected
       }), m(S, d.label, !0), O ? O.after(T) : t.element.append(T), O = T);
       for (C++; u.length > C;)d = u.pop(), m(S, d.label, !1), d.element.remove()
      }
      for (; Q.length > x;) {
       l = Q.pop();
       for (C = 1; C < l.length; ++C)m(S, l[C].label, !1);
       l[0].element.remove()
      }
      q(S, function (a, c) {
     ...
     var v;
     if (!(v = t.match(d)))throw jg("iexp",
         t, ua(f));
     var z = c(v[2] || v[1]), y = v[4] || v[6], F = / as /.test(v[0]) && v[1], B = F ? c(F) : null, G = v[5], J = c(v[3] || ""), C = c(v[2] ? v[1] : y), L = c(v[7]), K = v[8] ? c(v[8]) : null, P = {}, Q = [[{
      element: f,
      label: ""
     }]], R = {};
     ...
     f.on("change", function () {
      e.$apply(function () {
       var a = L(e) || [], c;
       if (s)c = [], q(f.val(), function (d) {
        d = K ? P[d] : d;
        c.push("?" === d ? u : "" === d ? null : h(B ? B : C, d, a[d]))
       }); else {
        var d = K ? P[f.val()] : f.val();
        c = "?" === d ? u : "" === d ? null : h(B ? B : C, d, a[d])
       }
       g.$setViewValue(c);
       r()
      })
    ...
    if (l[1]) {
     var n = l[0];
     l = l[1];
     var s = h.multiple, t = h.ngOptions, w = !1, v, p = !1, A = G(W.createElement("option")), E = G(W.createElement("optgroup")), z = A.clone();
     h = 0;
     for (var y = g.children(), F = y.length; h < F; h++)if ("" === y[h].value) {
      v = w = y.eq(h);
      break
     }
     n.init(l, w, z);
     s && (l.$isEmpty = function (a) {
      return !a || 0 === a.length
     });
     t ? r(e, g, l) : s ? m(e, g, l) : k(e, g, l, n)
    }
   }
  }
 ...
 }], ae = ca({restrict: "E", terminal: !1}), Dc = function () {
  return {
   restrict: "A", require: "?ngModel", link: function (a, c, d, e) {
   ...
   restrict: "A", require: "?ngModel", link: function (a, c, d, e) {
    if (e) {
     ...
     d.$observe("pattern", function (a) {
      K(a) && 0 < a.length &&
      (a = new RegExp("^" + a + "$"));
      if (a && !a.test)throw y("ngPattern")("noregexp", g, a, ua(c));
      f = a || u;
      e.$validate()
     });
     e.$validators.pattern = function (a, c) {
      return e.$isEmpty(c) || A(f) || f.test(c)
     }
    }
   }
  }
 ...
 S.angular.bootstrap ? console.log("WARNING: Tried to load angular more than once.") : (Rd(), Td(ba), G(W).ready(function () {
  Nd(W, wc)
 }))
})(window, document);
